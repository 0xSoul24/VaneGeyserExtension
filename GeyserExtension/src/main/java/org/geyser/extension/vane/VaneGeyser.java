...
public class VaneGeyser implements Extension {
    ...
    public void onPreInitialize(GeyserPreInitializeEvent event) {
        ...
        this.logger().info("");
        this.logger().info("##############################################");
        this.logger().info("REGISTERING ITEMS");
    ...
    public void onGeyserPreInitializeEvent(GeyserDefineCustomItemsEvent event) {
        ...
        // BOOK
        //
        CustomItemData ancient_tome = CustomItemData.builder().name("ancient_tome")
        ...
        // COMPASS
        //
        CustomItemData north_compass = CustomItemData.builder().name("north_compass")
        ...
        // DIAMOND HOE
        //
        CustomItemData diamond_sickle = CustomItemData.builder().name("diamond_sickle")
        ...
        // DROPPER
        //
        CustomItemData pouch = CustomItemData.builder().name("pouch")
        ...
        // ELYTRA
        //
        CustomItemData reinforced_elytra = CustomItemData.builder().name("reinforced_elytra")
        ...
        // GLASS BOTTLE
        //
        CustomItemData empty_xp_bottle = CustomItemData.builder().name("empty_xp_bottle")
        ...
        // GOLDEN HOE
        //
        CustomItemData golden_sickle = CustomItemData.builder().name("golden_sickle")
        ...
        // HONEY BOTTLE
        //
        CustomItemData small_xp_bottle = CustomItemData.builder().name("small_xp_bottle")
        ...
        CustomItemData medium_xp_bottle = CustomItemData.builder().name("medium_xp_bottle")
        ...
        CustomItemData large_xp_bottle = CustomItemData.builder().name("large_xp_bottle")
        ...
        // IRON HOE
        //
        CustomItemData iron_sickle = CustomItemData.builder().name("iron_sickle")
        ...
        // NETHERITE HOE
        //
        CustomItemData netherite_sickle = CustomItemData.builder().name("netherite_sickle")
        ...
        // PAPER
        //
        CustomItemData papyrus_scroll = CustomItemData.builder().name("papyrus_scroll")
        ...
        // SHULKER BOX
        //
        CustomItemData backpack = CustomItemData.builder().name("backpack")
        ...
        // SLIME BALL
        //
        CustomItemData slime_bucket = CustomItemData.builder().name("slime_bucket")
        ...
        CustomItemData slime_bucket_excited = CustomItemData.builder().name("slime_bucket_excited")
        ...
        // STONE HOE
        //
        CustomItemData stone_sickle = CustomItemData.builder().name("stone_sickle")
        ...
        //
        CustomItemData home_scroll = CustomItemData.builder().name("home_scroll")
        ...
        CustomItemData unstable_scroll = CustomItemData.builder().name("unstable_scroll")
        ...
        CustomItemData file = CustomItemData.builder().name("file")
        ...
        CustomItemData trowel = CustomItemData.builder().name("trowel")
        ...
        CustomItemData spawn_scroll = CustomItemData.builder().name("spawn_scroll")
        ...
        CustomItemData lodestone_scroll = CustomItemData.builder().name("lodestone_scroll")
        ...
        CustomItemData death_scroll = CustomItemData.builder().name("death_scroll")
        ...
        // WOODEN HOE
        //
        CustomItemData wooden_sickle = CustomItemData.builder().name("wooden_sickle")
